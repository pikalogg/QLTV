...
public interface CmdLines {
	...
	public static interface selectTable{
		...
		String SACH = "SELECT CONCAT('MS',RIGHT(CONCAT('000000',CAST(masach AS CHAR)), 6)) AS masach, tensach, theloai,tacgia, nxb, ngayxb, CONCAT(CAST(giatri AS CHAR),' VND') AS giatri, soluong FROM sach";
	...
	public static interface columnNames{
		...
		String[] SACH = {
				"Mã sách", "Tên sách", "Thể loại", "Tác giả", "NXB" , "Ngày xb" , "giá trị", "số lượng"
			};
		String[] QUYDINH = {
